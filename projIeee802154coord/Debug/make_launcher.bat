...
@REM   i.e.   ${workspace_loc:projIeee802154coord}/make_launcher.bat
...
@set ERIKA_FILES=C:\EE_RT-Druid-1.6.1-indigo-SR2-win32\eclipse\plugins\com.eu.evidence.ee_1.6.1.20120319_2002\ee_files
